/*
Dependency injection is a design pattern  which a class receives it's
dependencies from external sources rather than creating them itself.
This helps to making classes more moduler, flexible and easier to test
and there are various way to implementing dependency injection.
Common approach among them through the constructor injection.
 */
